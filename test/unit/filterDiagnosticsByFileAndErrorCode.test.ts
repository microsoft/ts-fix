import { ChangedFile, CLIHost, filterDiagnosticsByFileAndErrorCode } from "../../src/index";
...
const project = createProject({ tsConfigFilePath: "C:\\Users\\t-danayf\\Repositories\\ts-fix\\test\\integration\\cases\\addMissingMember\\tsconfig.json" }, allChangedFiles);
const sourceFile = project && project.program.getSourceFile("C:\\Users\\t-danayf\\Repositories\\ts-fix\\test\\integration\\cases\\addMissingMember\\a.ts");
